...
def build_settings_text() -> str:
    lines = [
        ...
        f"CPU threshold:         {settings.cpu_alert_threshold:.0f}%",
        f"Memory threshold:      {settings.memory_alert_threshold:.0f}%",
        f"Temperature threshold: {settings.temp_alert_threshold:.0f}°C",
        f"Battery low threshold: {settings.battery_low_threshold:.0f}%",
        "",
